...
WordListFile := '..\Lib\GitHubComboList249k.txt'    ; Mostly from github: Copyright (c) 2020 Wordnik
myLogFile := "..\Logs\MCLog.txt"
myAutoCorrectLibrary := "..\Lib\UserHotstringFIle.ahk"
...
;--- create systray menu ----
TraySetIcon("..\Media\JustLog.ico")    ; A fun homemade "log" icon that Steve made.
...
WordListPath := "..\Lib\GitHubComboList249k.txt"
